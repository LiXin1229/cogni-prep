 ...
 */
export const calculateDynamicTreeSize = (tree, options = {}) => {
    // 合并默认配置
    const config = {
        minSize: 0.8,
        maxSize: 8,
 ...
 */
const analyzeTreeStructure = (tree) => {
    let totalNodes = 0;
    let maxDepth = 0;
    let totalChildren = 0;
    ...
    // 计算平均子节点数（避免除以0）
    const avgChildren = nodesWithChildren > 0 
        ? totalChildren / nodesWithChildren 
        : 0;
